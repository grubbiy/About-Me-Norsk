...
const translations = {
  no: {
    ...
    "about.cyberNote": "Eg har sterk interesse for cybersecurity, men er tidleg i læringsløpet. Målet er å utvikle meg vidare innan blue team (overvaking, logging, analyse, respons) og på sikt red team i kontrollerte lab-miljø. Eg er mest motivert av å forstå kvifor ting skjer. AI hjelper meg å kome i gang raskare, men ambisjonen er reell kompetanse over tid.",
    ...
    "lab.stack1": "pfSense som ruter/brannmur og nettverksgrense i laben",
    "lab.stack2": "Windows Server for grunnleggande tenester (AD/DNS/DHCP i lab-kontekst)",
    "lab.stack3": "TrueNAS for lagring og AI-modell-storage",
    "lab.stack4": "Arch Linux-VM som køyrer Ollama for lokale LLM-modellar",
    "lab.stack5": "Ubuntu Server-VM som køyrer OpenWebUI for web-tilgang til modellane",
    "lab.detail": "Oppsettet er ein skule-/øvingslab i Proxmox, bygd med betydeleg AI-hjelp til planlegging, feilsøking og kommandoar. Det er laga for læring, ikkje produksjon, og har ingen sensitive data eller eksterne brukarar. Rekkefølgja gjev meining pedagogisk: nettverksgrensa kjem først, så grunnleggande tenester og lagring, før lokale AI-modellar og web-tilgang.",
    "lab.detail2": "Gjennom dette har eg lært meir om nettverkssamanhengar, VM-flyt og AI-integrasjon. Eg forstår arkitekturen og dataflyten, men lærer framleis kvart lag.",
  ...
  en: {
    ...
    "about.cyberNote": "I have a strong interest in cybersecurity, but I am early in the learning journey. My goal is to grow within blue team work (monitoring, logging, analysis, response) and later red team in controlled lab environments. I am most motivated by understanding why things happen. AI helps me get started faster, but the goal is real competence over time.",
    ...
    "lab.stack1": "pfSense as router/firewall and lab network boundary",
    "lab.stack2": "Windows Server for core services (AD/DNS/DHCP in lab context)",
    "lab.stack3": "TrueNAS for storage and AI model storage",
    "lab.stack4": "Arch Linux VM running Ollama for local LLM models",
    "lab.stack5": "Ubuntu Server VM running OpenWebUI for web access to models",
    "lab.detail": "The setup is a school practice lab in Proxmox, built with significant AI help for planning, troubleshooting, and commands. It is for learning, not production, and has no sensitive data or external users. The order makes sense pedagogically: the network boundary comes first, then core services and storage, then local AI models and web access.",
    "lab.detail2": "From this I have learned more about networking relationships, VM flow, and AI integration. I understand the architecture and data flow, but I am still learning each layer.",
